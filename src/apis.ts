...
import { decryptGidsFactory } from "./apis/decryptGids.js";
...
import { downloadTransferSyncFactory } from "./apis/downloadTransferSync.js";
...
import { requestSyncFromPhoneFactory } from "./apis/requestSyncFromPhone.js";
...
export class API {
    ...
    public decryptGids: ReturnType<typeof decryptGidsFactory>;
    ...
    public downloadTransferSync: ReturnType<typeof downloadTransferSyncFactory>;
    ...
    public requestSyncFromPhone: ReturnType<typeof requestSyncFromPhoneFactory>;
    ...
    constructor(ctx: ContextSession, zpwServiceMap: ZPWServiceMap, wsUrls: string[]) {
        ...
        this.decryptGids = decryptGidsFactory(ctx, this);
        ...
        this.downloadTransferSync = downloadTransferSyncFactory(ctx, this);
        ...
        this.requestSyncFromPhone = requestSyncFromPhoneFactory(ctx, this);
